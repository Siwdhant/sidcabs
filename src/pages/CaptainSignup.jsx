  ...
  return (
    <div className='p-7 h-screen flex flex-col justify-between w-full'>
      <div>
       ...
       <h3 className='text-xl .font-sans mb-2'>Whats Your name</h3>
       ...
       <input 
          ...
          <h3 className='text-lg .font-sans mb-2'>Whats Your email</h3>
          <input 
            required
            value={email}
          ...
          />  
          <h3 className='text-xl .font-sans mb-2'>What's your Password</h3>
          <input 
            required
            className='bg-[#eeeeee] mb-7 rounded px-4 py-2 border w-full text-lg placeholder:text'
            value={password}
        ...
        <p className='center-align'>Already Have a account? <Link to='/captain-login' className='text-blue-600'>Login Here</Link></p>
      </div>
      <div>
